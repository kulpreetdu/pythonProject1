...
class Add_Customer_Page:
    ...
    save_butt_xpath="//button[@name='save']"
    ...
    def save_click(self):
        self.driver.find_element(By.XPATH,self.save_butt_xpath).click()

    def msg_text(self):
        expected_message = "The new customer has been added successfully."
        actual_message = self.driver.find_element(By.XPATH,"//div[@class='alert alert-success alert-dismissable']").text
