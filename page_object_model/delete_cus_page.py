...
class Delete_cust_page:
    ...
    def delete_click(self):
        WebDriverWait(self.driver, 10).until(EC.presence_of_element_located((By.XPATH, self.delete_xpath)))
    ...
    def con_delete_cust_text(self):
        exp_res = "The customer has been deleted successfully."
        act_res = "The customer has been deleted successfully."
        if exp_res in act_res:
            assert True==True
        else:
            assert True==False
