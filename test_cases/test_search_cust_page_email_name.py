...
class Test_001_Search_Cust_By_Email_Name:
    ...
    def test_Search_cust_email1_name1(self, setup):
        self.logger.info("*****Test_01_search_customer_by_email_name*****")
